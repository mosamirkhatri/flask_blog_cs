...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(
            f'Account created for {form.username.data}!! You are now able to login', category="success")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash(
                'Login Unsuccessful. Please enter a valid E-mail and Password', 'danger')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'You password has been Updated!! You are now able to login',
              category="success")
        return redirect(url_for('users.login'))
